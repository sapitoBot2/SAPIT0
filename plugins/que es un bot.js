...
handler.customPrefix = /¿Qué es un Bot?|¿qué es un Bot?|qué es un Bot|que es un Bot|Qué es un Bot?|Que es un Bot?|que es un bot|Que es un bot?|Bot?|Que es un Bot??/i
